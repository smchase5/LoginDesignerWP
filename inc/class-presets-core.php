    ...
    private static function get_core_presets()
    {
        return array(
            ...
            'tech' => array(
                ...
                'is_pro' => true,
                'preview' => array(
                    'bg' => 'linear-gradient(135deg, #18181b, #3b0764)',
                    'form_bg' => '#27272a',
                ...
                'settings' => array(
                    'background_mode' => 'gradient',
                    'background_gradient_1' => '#18181b',
                    'background_gradient_2' => '#3b0764',
                    'gradient_type' => 'linear',
                    'gradient_angle' => 135,
            ...
            // ============================================
            'arctic_frost' => array(
                'name' => __('Arctic Frost', 'logindesignerwp'),
                'category' => 'nature',
                'is_pro' => true,
                'preview' => array(
                    'bg' => 'linear-gradient(135deg, #e0f2fe, #bae6fd)',
                    'form_bg' => 'rgba(255,255,255,0.7)',
                    'form_border' => '1px solid #7dd3fc',
                    'input_bg' => 'rgba(255,255,255,0.5)',
                    'button_bg' => '#0ea5e9',
                ),
                'settings' => array(
                    'background_mode' => 'gradient',
                    'background_gradient_1' => '#e0f2fe',
                    'background_gradient_2' => '#bae6fd',
                    'gradient_type' => 'linear',
                    'gradient_angle' => 135,
                    'form_bg_color' => 'rgba(255,255,255,0.7)',
                    'form_border_radius' => 24,
                    'form_border_color' => '#7dd3fc',
                    'label_text_color' => '#0369a1',
                    'input_bg_color' => 'rgba(255,255,255,0.5)',
                    ...
                    'below_form_link_color' => '#0369a1',
                    'logo_bottom_margin' => 25,
                ),
            ),
            'golden_hour' => array(
                'name' => __('Golden Hour', 'logindesignerwp'),
                'category' => 'creative',
                'is_pro' => true,
                'preview' => array(
                    'bg' => 'linear-gradient(135deg, #f59e0b, #d97706)',
                    'form_bg' => '#fffbeb',
                    'form_border' => '1px solid #fcd34d',
                    'input_bg' => '#ffffff',
                    'button_bg' => '#b45309',
                ),
                'settings' => array(
                    'background_mode' => 'gradient',
                    'background_gradient_1' => '#fcd34d',
                    'background_gradient_2' => '#b45309',
                    'gradient_type' => 'linear',
                    'gradient_angle' => 135,
                    'form_bg_color' => '#fffbeb',
                    'form_border_radius' => 16,
                    'form_border_color' => '#fcd34d',
                    'label_text_color' => '#92400e',
                    'input_bg_color' => '#ffffff',
                    'input_text_color' => '#451a03',
                    'input_border_color' => '#fbbf24',
                    'button_bg' => '#b45309',
                    'button_bg_hover' => '#92400e',
                    'button_text_color' => '#ffffff',
                    'button_border_radius' => 8,
                    'below_form_link_color' => '#92400e',
                    'logo_bottom_margin' => 25,
                ),
            ),
            'cyber_green' => array(
                'name' => __('Cyber Green', 'logindesignerwp'),
                'category' => 'creative',
                'is_pro' => true,
                'preview' => array(
                    'bg' => '#000000',
                    'form_bg' => '#111111',
                    'form_border' => '1px solid #00ff00',
                    'input_bg' => '#000000',
                    'button_bg' => '#00ff00',
                ),
                'settings' => array(
                    ...
                    'input_border_color' => '#003300',
                    'button_bg' => '#000000',
                    'button_bg_hover' => '#003300',
                    'button_text_color' => '#00ff00',
                    'button_border_radius' => 0,
                    'enable_glassmorphism' => 0,
                    'below_form_link_color' => '#00ff00',
                    'logo_bottom_margin' => 25,
                ),
            ),
            'cherry_blossom' => array(
                'name' => __('Cherry Blossom', 'logindesignerwp'),
                'category' => 'nature',
                'is_pro' => true,
                'preview' => array(
                    'bg' => 'linear-gradient(135deg, #fce7f3, #fbcfe8)',
                    'form_bg' => 'rgba(255,255,255,0.9)',
                    'form_border' => '1px solid #f9a8d4',
                    'input_bg' => '#fff1f2',
                    'button_bg' => '#ec4899',
                ),
                'settings' => array(
                    'background_mode' => 'gradient',
                    'background_gradient_1' => '#fce7f3',
                    'background_gradient_2' => '#fbcfe8',
                    'gradient_type' => 'linear',
                    'gradient_angle' => 135,
                    'form_bg_color' => 'rgba(255,255,255,0.9)',
                    'form_border_radius' => 20,
                    'form_border_color' => '#f9a8d4',
                    'label_text_color' => '#9d174d',
                    'input_bg_color' => '#fff1f2',
                    'input_text_color' => '#831843',
